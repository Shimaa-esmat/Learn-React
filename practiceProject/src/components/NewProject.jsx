...
export default function NewProject({onAdd,onCancel}) {
  ...
  return (
    <>
    <Modul ref={modal} buttonCaption='Cancel'>
      <h2 className="text-xl font-bold text-stone-500 my-4">Invalid Input</h2>
      <p className="text-stone-400 mb-4">Oops ... looks like you forgot to enter a value</p>
      <p className="text-stone-400 mb-4">Please make sure you ptovid a valid value for every input field. </p>
    </Modul>
